...
@Component({
  ...
  templateUrl: './vie-inst-detail-create-admin.component.html',
  styleUrls: ['./vie-inst-detail-create-admin.component.css']
})
...
ngOnInit(): void {
    ...
    this.vieInstitutionnelleService.findAll().subscribe((data) => this.vieInstitutionnelles = data);
        ...
        this.vieInstitutionnelleDetailInstrumentIrdsListe.forEach((element, index) => {
            if (element === p) { this.vieInstitutionnelleDetailInstrumentIrdsListe.splice(index, 1); }
        });
    }
        ...
        this.vieInstitutionnelleDetailEtablissementsListe.forEach((element, index) => {
            if (element === p) { this.vieInstitutionnelleDetailEtablissementsListe.splice(index, 1); }
        });
    }

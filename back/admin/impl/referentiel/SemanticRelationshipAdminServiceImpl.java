...
import com.ird.faa.dao.referentiel.SemanticRelationshipDao;
import com.ird.faa.service.admin.facade.referentiel.SemanticRelationshipAdminService;

import com.ird.faa.ws.rest.provided.vo.referentiel.SemanticRelationshipVo;
import com.ird.faa.service.util.*;

import com.ird.faa.service.core.impl.AbstractServiceImpl;

@Service
public class SemanticRelationshipAdminServiceImpl extends AbstractServiceImpl<SemanticRelationship>
		implements SemanticRelationshipAdminService {
	...
	public int delete(SemanticRelationship semanticRelationship) {
		if (semanticRelationship.getCode() == null)
			return -1;
	...
	public List<SemanticRelationship> findByCriteria(SemanticRelationshipVo semanticRelationshipVo) {
		...
		query += SearchUtil.addConstraintMinMax("o", "niveauExactitude",
				semanticRelationshipVo.getNiveauExactitudeMin(), semanticRelationshipVo.getNiveauExactitudeMax());
		query += " ORDER BY o.niveauExactitude";
		return entityManager.createQuery(query).getResultList();
	}

...
import com.ird.faa.service.admin.facade.referentiel.DisciplineScientifiqueChercheurAdminService;
...
import com.ird.faa.ws.rest.provided.vo.formulaire.DisciplineScientifiqueChercheurVo;

@Service
public class DisciplineScientifiqueChercheurAdminServiceImpl extends
		AbstractServiceImpl<DisciplineScientifiqueChercheur> implements DisciplineScientifiqueChercheurAdminService {
	...
	public DisciplineScientifiqueChercheur update(DisciplineScientifiqueChercheur disciplineScientifiqueChercheur) {
		DisciplineScientifiqueChercheur foundedDisciplineScientifiqueChercheur = findById(
				disciplineScientifiqueChercheur.getId());
		if (foundedDisciplineScientifiqueChercheur == null)
			return null;
		else {
	...
	@Override
	public List<DisciplineScientifiqueChercheur> save(
	...
	public int delete(DisciplineScientifiqueChercheur disciplineScientifiqueChercheur) {
		if (disciplineScientifiqueChercheur.getId() == null)
			return -1;
		DisciplineScientifiqueChercheur foundedDisciplineScientifiqueChercheur = findById(
				disciplineScientifiqueChercheur.getId());
		if (foundedDisciplineScientifiqueChercheur == null)
	...
	public List<DisciplineScientifiqueChercheur> findByCriteria(
			DisciplineScientifiqueChercheurVo disciplineScientifiqueChercheurVo) {
		...
		if (disciplineScientifiqueChercheurVo.getDisciplineScientifiqueVo() != null) {
			query += SearchUtil.addConstraint("o", "disciplineScientifique.id", "=",
					disciplineScientifiqueChercheurVo.getDisciplineScientifiqueVo().getId());
			query += SearchUtil.addConstraint("o", "disciplineScientifique.code", "LIKE",
					disciplineScientifiqueChercheurVo.getDisciplineScientifiqueVo().getCode());
		}
		...
		if (disciplineScientifiqueChercheurVo.getDisciplineScientifiqueErcVo() != null) {
			query += SearchUtil.addConstraint("o", "disciplineScientifiqueErc.id", "=",
					disciplineScientifiqueChercheurVo.getDisciplineScientifiqueErcVo().getId());
			query += SearchUtil.addConstraint("o", "disciplineScientifiqueErc.code", "LIKE",
					disciplineScientifiqueChercheurVo.getDisciplineScientifiqueErcVo().getCode());
		}

		if (disciplineScientifiqueChercheurVo.getChercheurVo() != null) {
			query += SearchUtil.addConstraint("o", "chercheur.id", "=",
					disciplineScientifiqueChercheurVo.getChercheurVo().getId());
			query += SearchUtil.addConstraint("o", "chercheur.numeroMatricule", "LIKE",
					disciplineScientifiqueChercheurVo.getChercheurVo().getNumeroMatricule());
		}
	...
	private void findDisciplineScientifique(DisciplineScientifiqueChercheur disciplineScientifiqueChercheur) {
		DisciplineScientifique loadedDisciplineScientifique = disciplineScientifiqueService
				.findByIdOrCode(disciplineScientifiqueChercheur.getDisciplineScientifique());
	...
	private void findDisciplineScientifiqueErc(DisciplineScientifiqueChercheur disciplineScientifiqueChercheur) {
		DisciplineScientifiqueErc loadedDisciplineScientifiqueErc = disciplineScientifiqueErcService
				.findByIdOrCode(disciplineScientifiqueChercheur.getDisciplineScientifiqueErc());
	...
	private void findChercheur(DisciplineScientifiqueChercheur disciplineScientifiqueChercheur) {
		Chercheur loadedChercheur = chercheurService
				.findByIdOrNumeroMatricule(disciplineScientifiqueChercheur.getChercheur());
